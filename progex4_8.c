/* Write a program that asks the user to enter the number of miles 
   ...
   per distance (lower is better).
   Use symbolic constants (using "const" or "#define") for the two 
   conversion factors. CHAPTER 4 WORK for HW2_3 */
